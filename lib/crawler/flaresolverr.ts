...
function getFlareSolverrUrl(): string | null {
  ...
  // Empty FLARESOLVERR_URL= in dotenv/shell blocks Next from loading a later .env value.
  // Local Compose always publishes FlareSolverr on 8191 for `npm run dev` / `dev:all`.

  ...
  try {
    ...
    return {
      ...
      categories: {
        ...
        capabilities: typeof parsed.capabilities === 'number' ? parsed.capabilities : null,
      },
      agentReadiness: typeof parsed.agentReadiness === 'number' ? parsed.agentReadiness : undefined,
      findings: playbook,
